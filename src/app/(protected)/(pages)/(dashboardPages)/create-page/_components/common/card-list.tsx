...
import Card from "@/app/(protected)/(pages)/(dashboardPages)/create-page/_components/common/card";
import AddCardButton from "@/app/(protected)/(pages)/(dashboardPages)/create-page/_components/common/add-card-button";
